...
focus = [
    ...
    "Remote sensing & geospatial AI  (Sentinel-2, Google Earth Engine)",
    "Supervised ML & deep learning   (CNNs, fine-tuned Transformers)",
    "API serving & MLOps             (FastAPI, Docker, Gradio)",
    "Data analysis & interpretability (EDA, SHAP, feature engineering)",
]
```
...
![SHAP](https://img.shields.io/badge/SHAP-4C72B0?style=flat)
...
![NLTK](https://img.shields.io/badge/NLTK-3d7a35?style=flat)
...
![Gradio](https://img.shields.io/badge/Gradio-FF6B35?style=flat&logo=gradio&logoColor=white)
...
### [GbeTo — Ewé ↔ French Translator](https://github.com/kjd-dktech/GbeTo_ewe-fr)

Fine-tuning of **NLLB-200-distilled-600M** (Meta AI) for bidirectional Ewé ↔ French neural machine translation. Low-resource NLP for an under-resourced West African language — *my mother tongue*.

`PyTorch` `HuggingFace` `NLLB-200` `seq2seq` `sacrebleu`

| Baseline BLEU | Fine-tuned BLEU |
|:---:|:---:|
| 13.41 | **16.70** |

[![Repo](https://img.shields.io/badge/GitHub-GbeTo__ewe--fr-181717?style=flat&logo=github&logoColor=white)](https://github.com/kjd-dktech/GbeTo_ewe-fr)
[![HF Model](https://img.shields.io/badge/%F0%9F%A4%97_Model-gbeto--ewe--french-FFD21E?style=flat)](https://huggingface.co/kjd-dktech/gbeto-ewe-french)
[![Demo](https://img.shields.io/badge/%F0%9F%A4%97_Demo-gbeto--ewe--french--demo-FFD21E?style=flat)](https://huggingface.co/spaces/kjd-dktech/gbeto-ewe-french-demo)
